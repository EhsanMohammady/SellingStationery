namespace SellingStationery.DataProcessor.Parsing;
...
public class CsvLineParserTests
{
    ...
    {
        // Arrange
        string[] csvLines = new[] { "Book;10/27/2022 8:06:04 AM" };
        ...
        Assert.Equal("Book", machineDataItems[0].StationeryCountStoreType);
    ...
    [InlineData("Book", "Invalid csv line")]
    [InlineData("Book;InvalidDateTime", "Invalid datetime in csv line")]
    [Theory]
